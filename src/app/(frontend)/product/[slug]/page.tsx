...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  return (
    <>
      ...
      <nav className="w-full px-4 sm:px-6 lg:px-8 py-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 overflow-x-auto whitespace-nowrap">
            ...
            <li className="text-gray-400 dark:text-gray-600">→</li>
            <li className="text-gray-900 dark:text-white font-semibold truncate max-w-32 sm:max-w-none">
              {product.name}
            </li>
          </ol>
        </div>
      ...
      <main className="w-full bg-gray-50 dark:bg-gray-900">
        <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 bg-white dark:bg-gray-800">
          <div className="max-w-7xl mx-auto">
                  ...
                  <div className="flex items-baseline space-x-3 mb-2">
                    ...
                    {originalPrice && (
                      <>
                        ...
                        <span className="text-lg font-semibold text-green-600 dark:text-green-400">Save ₹{originalPrice - price}</span>
                      </>
                    )}
                  </div>
                      ...
                      {product.details.split('\n').map((detail: string, index: number) => {
                        ...
                        return (
                          <div key={index} className="flex border-b border-gray-100 dark:border-gray-800 pb-2 last:border-0">
                            <span className="font-semibold text-gray-700 dark:text-gray-300 w-32 flex-shrink-0">{key}:</span>
              ...
              <div className="order-2 lg:order-1">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-700 hover:bg-yellow-50 dark:hover:bg-yellow-900/20 transition-colors duration-300">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 dark:text-white mb-2 text-lg">Perfect Fit</h3>
              ...
              <div className="order-1 lg:order-2">
                <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-2xl flex items-center justify-center shadow-xl border-4 border-gray-200 dark:border-gray-700 overflow-hidden">
                  <div className="text-center p-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 font-medium">Product lifestyle image</p>
                  </div>
                </div>
              </div>
            </div>
